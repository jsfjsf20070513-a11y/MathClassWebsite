      ...
      <main>
        ...
        <section id="gallery" className="section-container">
          <div className="section-header">
            <h2>光影印记 · Galerie</h2>
            <Link to="/gallery" className="view-all">查看全部 <ChevronRight size={16} /></Link>
          </div>
        ...
        <section id="timeline" className="section-container bg-light">
          <div className="section-header">
            <h2>岁月如歌 · Timeline</h2>
            <Link to="/timeline" className="view-all">查看全部 <ChevronRight size={16} /></Link>
          </div>
        ...
        <section id="announcements" className="section-container">
          <div className="section-header">
            <h2>最新通知 · Annonces</h2>
            <Link to="/announcements" className="view-all">查看全部 <ChevronRight size={16} /></Link>
          </div>
